  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Quick Task - Login', style:
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(177, 243, 92, 1))),
        ...
        child: Column(
          ...
          children: [
            Center(
              ...
              Center(
                child: const Text('Student ID: 2021mt70605',
                    style:
                        TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 42, 42, 42))),
              ),
              SizedBox(
            ...
            Center(
                child: const Text('Quick Task',
                    style:
                        TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Color.fromRGBO(18, 0, 17, 1))),
              ),
              SizedBox(
                height: 2,
              ),
      ...
      backgroundColor: Color.fromARGB(255, 158, 193, 248),
    );
  }
